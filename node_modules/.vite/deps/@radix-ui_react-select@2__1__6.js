...
import {
  ...
  __spreadArray,
  init_tslib_es6
} from "./chunk-V6VHMQ7B.js";
import {
  useCallbackRef
} from "./chunk-TUZSIKE4.js";
import {
  useId
} from "./chunk-NQ66YLZJ.js";
import {
  clamp
...
import {
  createCollection,
  useDirection
} from "./chunk-CKDIP3G5.js";
import {
  usePrevious,
  useSize
} from "./chunk-IN3F2MAF.js";
import {
  Primitive,
  ...
  useLayoutEffect2
} from "./chunk-RIYQ4T4M.js";
import {
  composeRefs,
  useComposedRefs
} from "./chunk-FARUAG47.js";
import {
  require_jsx_runtime
} from "./chunk-NRBATONI.js";
import {
  require_react_dom
} from "./chunk-AP6GYKF3.js";
import {
  require_react
...
function createSlot(ownerName) {
  ...
  const Slot22 = React9.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime6.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React9.isValidElement(newElement) ? React9.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React20.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React20.useState(false);
  ...
  const triggerPointerDownPosRef = React20.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React20.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime8.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime8.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React20.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React20.useCallback((option) => {
...
var SelectTrigger = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React20.useRef("touch");
...
var SelectValue = React20.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React20.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React20.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME2, props.__scopeSelect);
    const [fragment, setFragment] = React20.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React20.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React20.useState(null);
    const [selectedItemText, setSelectedItemText] = React20.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React20.useState(false);
    const firstValidItemFoundRef = React20.useRef(false);
    React20.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst2 = React20.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React20.useCallback(
    ...
    const itemRefCallback = React20.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React20.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React20.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React20.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME2, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME2, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React20.useState(null);
  const [content, setContent] = React20.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection(__scopeSelect);
  const shouldExpandOnScrollRef = React20.useRef(false);
  const shouldRepositionRef = React20.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React20.useCallback(() => {
  ...
  const handleScrollButtonChange = React20.useCallback(
    (node) => {
...
var SelectPopperPosition = React20.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React20.forwardRef(
  (props, forwardedRef) => {
    const { __scopeSelect, nonce, ...viewportProps } = props;
    const contentContext = useSelectContentContext(VIEWPORT_NAME, __scopeSelect);
    const viewportContext = useSelectViewportContext(VIEWPORT_NAME, __scopeSelect);
    const composedRefs = useComposedRefs(forwardedRef, contentContext.onViewportChange);
    const prevScrollTopRef = React20.useRef(0);
...
var SelectGroup = React20.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React20.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React20.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React20.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime8.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React20.useCallback((node) => {
...
var SelectItemText = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React20.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React20.useMemo(
...
var SelectItemIndicator = React20.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React20.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React20.useState(false);
...
var SelectScrollDownButton = React20.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React20.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React20.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React20.useRef(null);
  const getItems = useCollection(__scopeSelect);
  const clearAutoScrollTimer = React20.useCallback(() => {
...
var SelectSeparator = React20.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React20.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React20.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React20.useCallback(
    (key) => {
  ...
  const resetTypeahead = React20.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React20.useEffect(() => {
